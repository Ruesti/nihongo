...
void main() {
  ...
  test('INV-4: rejects a non-singleton item whose occurrences drop below two',
      () {
    // これ occurs exactly twice in the real fixture: once in Panel 5 (これ？)
    // and once in Panel 6 (これ、こわれた). Dropping the Panel-5 bubble
    ...
    (panel5['bubbles'] as List).removeWhere((b) => (b as Map)['text'] == 'これ？');
